...
public final class ZEDTools
{
   public static String errorName(int zedErrorCode)
   {
      ...
      {
         case SL_ERROR_CODE_POTENTIAL_CALIBRATION_ISSUE -> "SL_ERROR_CODE_POTENTIAL_CALIBRATION_ISSUE";
         ...
         case SL_ERROR_CODE_DRIVER_FAILURE -> "SL_ERROR_CODE_DRIVER_FAILURE";
         default -> "UNKNOWN";
      };
   }

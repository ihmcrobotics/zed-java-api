...
public static final int
	...
	/** Fast and accurate, in both exploratory mode and mapped environments.\Note Can be used even if depth_mode is set to \ref SL_DEPTH_MODE_NONE. */
...
public static final int
	...
	/** Last object subclass, used for iteration purposes. */
...
// #endif
	...
	public static native void sl_free(Pointer ptr);
    ...
    */
	...
	@param count [out] : The number of sensors data available in the batch.
    @param camera_id : Id of the camera instance.
    @return \ref SL_ERROR_CODE "SL_ERROR_CODE_SUCCESS" if sensors data have been extracted.
    @return \ref SL_ERROR_CODE "SL_ERROR_CODE_SENSORS_NOT_AVAILABLE" if the camera model is a \ref SL_MODEL "SL_MODEL_ZED".
    @return \ref SL_ERROR_CODE "SL_ERROR_CODE_MOTION_SENSORS_REQUIRED" if the camera model is correct but the sensors module is not opened.
    @return \ref SL_ERROR_CODE "SL_ERROR_CODE_INVALID_FUNCTION_PARAMETERS" if the <b>reference_time</b> is not valid.
    */
    public static native int sl_get_sensors_data_batch_count(int camera_id, IntPointer count);
    public static native int sl_get_sensors_data_batch_count(int camera_id, IntBuffer count);
    public static native int sl_get_sensors_data_batch_count(int camera_id, int[] count);
    /**
    ...
    @param data [out] : The SensorsData array to store the data.
    @param camera_id : Id of the camera instance.
    @return \ref SL_ERROR_CODE "SL_ERROR_CODE_SUCCESS" if sensors data have been extracted.
    @return \ref SL_ERROR_CODE "SL_ERROR_CODE_SENSORS_NOT_AVAILABLE" if the camera model is a \ref SL_MODEL "SL_MODEL_ZED".
    @return \ref SL_ERROR_CODE "SL_ERROR_CODE_MOTION_SENSORS_REQUIRED" if the camera model is correct but the sensors module is not opened.
    @return \ref SL_ERROR_CODE "SL_ERROR_CODE_INVALID_FUNCTION_PARAMETERS" if the <b>reference_time</b> is not valid.
    */
    public static native int sl_get_sensors_data_batch(int camera_id, @Cast("SL_SensorsData**") PointerPointer data);
    public static native int sl_get_sensors_data_batch(int camera_id, @ByPtrPtr SL_SensorsData data);
...
// #if WITH_OBJECT_DETECTION
    ...
    */
    ...
    public static native int sl_generate_unique_id_str(@Cast("char*") BytePointer uuid);
    public static native int sl_generate_unique_id_str(@Cast("char*") ByteBuffer uuid);
    public static native int sl_generate_unique_id_str(@Cast("char*") byte[] uuid);
